...
const composeSource = `services:
  minimal-props-api:
    ...
    environment:
      ...
      PROTOTYPE_RELEASED_SIGNER_KEY_ID: "\${PROTOTYPE_RELEASED_SIGNER_KEY_ID:-}"
      PROTOTYPE_RELEASED_SIGNER_KEY_PROVIDER_ID: "\${PROTOTYPE_RELEASED_SIGNER_KEY_PROVIDER_ID:-prototype-released-signing-key-provider-v1}"
      PROTOTYPE_RELEASED_SIGNER_KEYRING_JSON: "\${PROTOTYPE_RELEASED_SIGNER_KEYRING_JSON:-}"
      PROTOTYPE_RELEASED_SIGNER_REQUIRE_ATTESTATION: "\${PROTOTYPE_RELEASED_SIGNER_REQUIRE_ATTESTATION:-true}"
      PROTOTYPE_RELEASED_SIGNER_MIN_EXECUTION_MODE: "\${PROTOTYPE_RELEASED_SIGNER_MIN_EXECUTION_MODE:-tee_verified}"
      PROTOTYPE_RELEASED_SIGNER_ALLOWED_PROVIDER_IDS: "\${PROTOTYPE_RELEASED_SIGNER_ALLOWED_PROVIDER_IDS:-}"
      PROTOTYPE_RELEASED_SIGNER_ALLOWED_MEASUREMENTS: "\${PROTOTYPE_RELEASED_SIGNER_ALLOWED_MEASUREMENTS:-}"
      PROTOTYPE_RELEASED_SIGNER_ALLOWED_QUOTE_FORMATS: "\${PROTOTYPE_RELEASED_SIGNER_ALLOWED_QUOTE_FORMATS:-}"
